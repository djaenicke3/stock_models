...
return_dict = {}
#
# #"TARS","MIRM","AX","HERXF","CFPZF","IFSPF","KRG","CESDF","RPTX","OCFC","RWT","XPOF","EVRI","NOG","NGM","CBAY","SECYF","PKIUF","BAC","BLDR","CARR","CFG","CIM","CNQ","CTVA","DISCK","ET","FCX","FHN","FITB","FLEX","GGB","GLW","GPS","HBAN","HPQ","IBN","IPG","CHPT","JMIA","BP","XLF","AAL","MO"]
tickers = ['DLPN',
'DNA',
'DRH',
'DSKE',
